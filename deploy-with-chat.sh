#!/bin/bash
# deploy-with-chat.sh - Deploy Expense Management System with AI Chat features
# This script deploys everything including Azure OpenAI and AI Search resources
...
echo "WITH AI Chat Features"
echo "=========================================="
echo "Resource Group: $RESOURCE_GROUP"
echo "Location: $LOCATION (GenAI in swedencentral)"
...
echo "  - Azure OpenAI: (in swedencentral)"
echo "  - Azure AI Search: (in swedencentral)"
echo ""
echo "GenAI Settings:"
echo "  - OpenAI Endpoint: $OPENAI_ENDPOINT"
...
echo ""
echo "The AI Chat feature is now enabled and can be accessed at ${APP_SERVICE_URL}/Chat"
